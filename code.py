...
def wishMe():
    ...
    if hour>=6 and hour<12:
        speak("Good Morning Gowtham bopaiah")

    elif hour>=12 and hour<18:
        speak("Good Gowtham bopaiah")

    elif hour>=18 and hour<24:
        speak("Good Evening Gowtham bopaiah")

    else:
        speak("Good Night Gowtham bopaiah")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        elif 'how is the weather' or 'weather' in query:
